...
```
  ...
  - 사이트 폴더: 누구나 사이트를 알아볼 수 있게 영어로 작성합니다.
    - 예) baekjoon, programmers, codeground, book
...
- 편의상 이니셜로 적겠습니다. kec는 kjy와 ojs 2명을 리뷰해야합니다. kjy는 ojs와 yyh를 리뷰해야 합니다.
 -->
- 1주일동안 해결한 알고리즘 문제를 주말 혹은 주중에 함께 코드리뷰를 작성합니다.
- 모든 문제를 리뷰할 수 없으므로 어려웠던 문제를 선정하여 진행합니다.
- 선정되지 않은 문제들중 개인적으로 궁금하다면 다른사람의 branch로 확인합니다.
